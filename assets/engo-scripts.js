...
//       nextArrow: '<button type="button" class="slick-brand-next ti-angle-right"></button>',
     ...
     $('.product-img-box').slick({
       ...
       fade: false,
       infinite: false,
       asNavFor: '.box-thumbnail-pr'
     });
     $('.box-thumbnail-pr').slick({
       slidesToShow: 4,
       slidesToScroll: 1,
       arrows: false,
       asNavFor: '.product-img-box',
       dots: false,
       fade: false,
       infinite: false,
       focusOnSelect: true
...
//     });
  ...
  function FilterPushLeft(){
    $('.js_filter_mobile').on('click',function(){
  ...
  "use strict";
   ...
   function productv2(){
    ...
    function Blogv1(){
     ...
     function producth3handpicked(){
    $('.slick_product_handpicked').slick({
      arrows: true,
      infinite: false,
      dots: false ,
      speed: 300,
